...
모임에서 각자 결제한 비용을 기록하고, 최소한의 송금으로 정산할 수 있도록 도와주는 앱인토스 미니앱입니다.
...
정산 시에는 각 참여자의 순잔액을 계산한 뒤 최대 채권자와 최대 채무자를 매칭하는 Splitwise 방식으로 송금 횟수를 줄입니다. 계산된 결과에서는 토스 송금 딥링크를 이용해 실제 송금 단계까지 자연스럽게 이어갈 수 있습니다. 모임별 대표 사진도 함께 저장해 지난 모임의 기록을 한눈에 확인할 수 있습니다.
